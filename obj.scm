...
(define (ask object message #!rest args)
...
(define (get-method give-up-name message #!rest objects)
  (if (null? objects)
...
(define-macro (define-class #!rest body) (make-definitions body))
